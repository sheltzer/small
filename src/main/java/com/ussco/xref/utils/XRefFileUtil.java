...
public final class XRefFileUtil {
	private static Logger log= Logger.getLogger(XRefFileUtil.class);
	...
	/**
	 * Returns the path for the XREF file share(eg. /my_root/subdirectory/)
	 * 
	 * @return
	 */
    public static String getFileSharePath()
	{
		...
		path.append(System.getProperty(ApplicationResourcesReader.getFileShareRoot()));
		path.append(ApplicationResourcesReader.getFileShareAppender());
		path.append(ApplicationResourcesReader.getFileShareContextRoot());

		return path.toString();
		
	}//end method getFileShareDirectory()
